...
class Config():
    def __init__(self, config_file=config_file_path):
        ...
        # MySQL 数据库名
        self.MYSQL_DATABASE = self.config.get('mysql', 'database', fallback='enterprise_qa')
        ...
        # Milvus 集合名
        self.MILVUS_COLLECTION_NAME = self.config.get('milvus', 'collection_name', fallback='enterprise_policy_kb')
