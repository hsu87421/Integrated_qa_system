    ...
    def insert_data(self, csv_path):
        try:
            ...
            for _, row in data.iterrows():
                insert_query = "INSERT INTO jpkb (policy_type, question, answer) VALUES (%s, %s, %s)"
                self.cursor.execute(insert_query, (row["制度类型"], row["问题"], row["答案"]))
            self.connection.commit()
...
if __name__ == '__main__':
    ...
    # mysql_client.insert_data(csv_path='../data/企业制度问答.csv')
