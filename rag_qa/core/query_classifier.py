...
class QueryClassifier:
    def __init__(self, model_path="bert_query_classifier"):
        ...
        # 定义标签映射
        self.label_map = {"公共信息查询": 0, "企业制度咨询": 1}
        # 加载模型
        self.load_model()
    ...
    def train_model(self, data_file=os.path.join(rag_qa_path, "classify_data", "enterprise_intents.jsonl")):
       #todo """训练 BERT 分类模型"""
        # 加载数据集
